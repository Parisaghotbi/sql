...
SELECT *, sum(distinct booth_number)
...
SELECT cp.customer_id,customer_first_name,customer_last_name, sum(quantity * cost_to_customer_per_qty) as total_cost
